...
logger = get_logger("scraper.quantiphi")


class QuantiphiScraper(BaseScraper):
    """Scrapes jobs from Quantiphi's official career portal."""
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.company_name = "Quantiphi"
        self.fallback_url = "https://quantiphi.wd1.myworkdayjobs.com/Careers"
    ...
    def scrape(self) -> list[JobListing]:
        """Scrape jobs from Quantiphi careers portal."""
        ...
        try:
            ...
            if platform == "Workday":
                subdomain = "quantiphi.wd1.myworkdayjobs.com"
                tenant = "Quantiphi_Careers"
                url = api_endpoint or f"https://{subdomain}/wday/cxs/{tenant}/Careers/jobs"
